#!/usr/bin/env python3
"""
Write one Beer Hall archive file (Markdown + YAML frontmatter) into *this*
...
Optional **`--repo PATH`** overrides the output repo (defaults to this checkout).

Then: **`git add beer_hall/entries`** → **`git commit`** → **PR / merge** to `main`.
"""
