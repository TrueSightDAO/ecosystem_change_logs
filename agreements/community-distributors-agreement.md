...
This Distributors Agreement ("Agreement") is entered into on \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_ ("Effective Date") by and between:

**TrueTech Inc, acting as legal representative of the TrueSight DAO community ("Consignor")**

3041 Taraval Street, San Francisco, CA 94116, USA

And

**Address \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_ ("Consignee")**

---

**WHEREAS**, the Consignor, on behalf of TrueSight DAO, owns Agroverse regenerative cacao products ("Products") as listed in Schedule A;

**WHEREAS**, the Community Distributor is engaged in selling and marketing products at the above address;

**WHEREAS**, the Consignor, acting for TrueSight DAO, appoints the Consignee as a non-exclusive agent for the sale of Products under the terms below.

**NOW, THEREFORE**, the parties agree as follows:

**Article 1: Definitions**

1.1 **Products**: Agroverse regenerative cacao products listed in Schedule A.

1.2 **TDG**: TrueSight DAO governance token for voting rights.

1.3 **Community Distributor**: A Consignee or Brand Representative appointed to sell or distribute Products under this Agreement.

1.4 **Consignor**: TrueTech Inc, acting as legal representative of the TrueSight DAO community.

## **Article 2: Appointment and Authority**

2.1 The Consignee selects one consignment option by checking one box below:

* \[     \] **Option A**: 100% pre-purchase at wholesale cost price (Schedule A).
...
3.1 **Pricing**: Per Schedule A. Community Distributors may set retail prices but are encouraged to follow recommended prices. Community Distributor covers all marketing and sales costs unless otherwise specified.

3.2 **Option A**: Community Distributor pays cost price upfront. Consignee covers all marketing and sales costs unless otherwise specified. Consignee covers all marketing and sales costs unless otherwise specified.
...
4.1 Consignor delivers Products to the Community Distributor’s specified address.

4.2 Community Distributor stores Products securely and is liable for loss or damage.

## 

## **Article 5: Payment and Accounting**

5.1 Community Distributor ensures payment collection and verifies customer payment before release.

5.2 Community Distributor provides monthly sales reports (units sold, inventory remaining).

5.3 Payments (cost price or full retail per option) due within 30 days of sale.

## **Article 6: Funds Transfer Instructions**

6.1 Community Distributor shall transfer funds from Product sales to the Consignor’s DAO treasury using the following methods:

* Currency: USD or USDT.  
* Venmo: @garyjob  
* Bank Transfer via [Wise.com](http://Wise.com):  
  * Bank: Wells Fargo Bank, N.A., 420 Montgomery, San Francisco, CA 94104, USA  
  * Account Holder: Zhiwen Teh  
  * Routing Number: 121000248  
  * SWIFT Code: WFBIUS6S  
  * Account Number: 3650834264

* Credit Card via PayPal: [admin@truesight.me](mailto:admin@truesight.me)  
* USDC (Solana): 48xsMyMx4nDfgxyB8AspumVaeART3cQWzFwYE82UZsFg  
* USDT (Ethereum): 0xCcAc98d0DB074538859b3bAB43c77B7968a94C40

6.2 Transfers support regenerative cacao farming and Amazon rainforest restoration.

## **Article 7: Termination**

6.1 Either party may terminate with 30 days’ written notice.  
6.2 Upon termination, Community Distributor returns all unsold Products.

## **Article 8: Governing Law**

8.1 Governed by Delaware, USA law. Disputes resolved in Delaware courts.
...
## **Schedule B: Consignment Options**

* **Option A**: Community Distributor pre-purchases Products at cost price.
