...
Daily evidence digests are generated by `market_research/scripts/generate_advisory_snapshot.py` (git + `CONTEXT_UPDATES` + Beer Hall excerpts; optional `--with-sheet-sales`, `--with-rem`, `--reminders-json`).
