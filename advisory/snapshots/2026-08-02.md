...
- Generated (UTC): `2026-08-02T08:43:22Z`
...
- Generated (UTC): `2026-08-01T10:59:14.327Z`
...
- **Email Agent Follow Up** — logged sends: warmup **619**, follow_up **70**, bulk **0**, unknown **2** (data rows: **691**)
- Distinct recipient addresses (`to_email`, by log `status`): warmup **88**, follow_up **23**, bulk **0**, unknown **2**

### Hit List cohorts (stores in stage × AU/AV send counts)

- **AI: Warm up prospect**: **64** stores — sum logged **warmup** sends (AU): **556**, sum logged **follow-up** sends (AV): **0**; warmup depth (none / once / ≥2): **1** / **0** / **63**; follow-up depth (none / once / ≥2): **64** / **0** / **0**
...
### `beer-hall_2026-07-31T025739Z_cacao-logistics-narrative-live.md`

- **posted_at_utc:** `2026-07-31T02:57:39Z`  
- **slug:** `cacao-logistics-narrative-live`  
- **Message 1 excerpt (first two non-empty lines):**

  Automated daily digest of the DAO
  - **Narrative** — Published explainer on the cacao logistics route from Brazil to San Francisco.
...
| 2026-08 | 0 | 16911.06386 | 8/2/2026 0:57:16 |
